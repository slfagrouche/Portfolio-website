...
const About = () => {
  const coreSkills = [
    ...
    { name: "TensorFlow", level: "Advanced", percentage: 88 },
    { name: "LangChain", level: "Advanced", percentage: 90 }
  ];
        ...
        <div className="flex flex-col md:flex-row gap-12 mt-12">
          <div className="md:w-1/2">
            <div className="pr-0 md:pr-6">
              <div className="p-6 rounded-lg bg-primary/5 dark:bg-primary/10 mb-8">
                <p className="text-neutral-700 dark:text-neutral-300 leading-relaxed text-lg">
                  AI Software Engineer specializing in backend engineering and machine learning solutions, with a passion for developing robust AI systems that solve real-world problems.
                </p>
              ...
              <div className="grid grid-cols-1 gap-6">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div className="p-5 beige-card bg-primary/5 dark:bg-primary/10 h-full">
                    ...
                    <ul className="text-neutral-700 dark:text-neutral-300 text-sm space-y-2 mt-2">
                      ...
                      <li className="flex items-start">
                        ...
                        <span>Architected ML infrastructure on AWS</span>
                      </li>
                    </ul>
                  </div>
                  ...
                  <div className="p-5 beige-card bg-primary/5 dark:bg-primary/10 h-full">
                    ...
                    <div className="flex items-center mt-3">
                      ...
                      <p className="text-neutral-600 dark:text-neutral-400 text-sm">Study abroad experience in Morocco and Japan</p>
                    </div>
                  </div>
                </div>
                
                {/* Fellowships & Leadership Section */}
                <div className="grid md:grid-cols-2 gap-6">
                  <div className="p-5 beige-card bg-primary/5 dark:bg-primary/10 h-full">
                    <div className="flex items-center mb-3">
          ...
          <div className="md:w-1/2">
            <div className="p-6 beige-card bg-card backdrop-blur-sm mb-6">
            ...
            <div className="p-6 beige-card bg-card backdrop-blur-sm">
              <div className="flex items-center mb-3">
                ...
                <h3 className="font-semibold text-primary dark:text-primary mb-0">Certifications & Credentials</h3>
              </div>
              <div className="space-y-3 mt-4 max-h-[400px] overflow-y-auto pr-2 scrollbar-thin">
