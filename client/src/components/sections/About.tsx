...
const About = () => {
  ...
  return (
    <section id="about" className="py-12 beige-section-alt fade-in">
          ...
          <div className="md:w-1/2">
            <div className="pr-0 md:pr-6">
              ...
              <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-3">
                <div className="p-3 beige-card bg-primary/5 dark:bg-primary/10">
                  <div className="flex items-center mb-2">
                    ...
                    <h3 className="font-semibold text-primary dark:text-primary text-sm mb-0">Education</h3>
                  </div>
                  <p className="text-neutral-800 dark:text-neutral-200 font-medium text-sm">{aboutDetails.education.degree}</p>
                  <p className="text-neutral-600 dark:text-neutral-400 text-xs">{aboutDetails.education.school}</p>
                  <p className="text-neutral-600 dark:text-neutral-400 text-xs mt-1">📚 Studied abroad in Morocco and Japan</p>
                </div>
                
                <div className="p-3 beige-card bg-primary/5 dark:bg-primary/10">
                  <div className="flex items-center mb-2">
                    <svg className="w-4 h-4 mr-2 text-primary" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118l-2.8-2.034c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"></path></svg>
                    <h3 className="font-semibold text-primary dark:text-primary text-sm mb-0">Certifications</h3>
                  </div>
                  <p className="text-neutral-800 dark:text-neutral-200 font-medium text-sm">{aboutDetails.certifications.title}</p>
                  <p className="text-neutral-600 dark:text-neutral-400 text-xs">{aboutDetails.certifications.others}</p>
                </div>
                ...
                <div className="p-3 beige-card bg-primary/5 dark:bg-primary/10">
                  <div className="flex items-center mb-2">
                    ...
                    <h3 className="font-semibold text-primary dark:text-primary text-sm mb-0">Languages</h3>
                  </div>
                  <div className="grid grid-cols-3 gap-1 mt-1">
                    {personalInfo.languages?.map((language, index) => (
                      <div key={index} className="flex items-center">
                        <svg className="w-3 h-3 text-primary mr-1 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                          <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                        </svg>
                        <span className="text-neutral-700 dark:text-neutral-300 text-xs">{language}</span>
                      </div>
                    ))}
                  </div>
                </div>
                ...
                <div className="p-3 beige-card bg-primary/5 dark:bg-primary/10">
                  <div className="flex items-center mb-2">
                    ...
                    <h3 className="font-semibold text-primary dark:text-primary text-sm mb-0">Hobbies & Interests</h3>
                  </div>
                  <div className="grid grid-cols-2 gap-1 mt-1">
                    {personalInfo.hobbies?.map((hobby, index) => (
                      <div key={index} className="flex items-center">
                        ...
                        <span className="text-neutral-700 dark:text-neutral-300 text-xs">{hobby}</span>
                      </div>
                    ))}
                  </div>
                </div>
                ...
                <div className="p-3 beige-card bg-primary/5 dark:bg-primary/10">
                  <div className="flex items-center mb-2">
                    ...
                    <h3 className="font-semibold text-primary dark:text-primary text-sm mb-0">Leadership Roles</h3>
                  </div>
                  <ul className="text-neutral-700 dark:text-neutral-300 text-xs space-y-1 pl-4 mt-1">
                ...
                <div className="p-3 beige-card bg-primary/5 dark:bg-primary/10">
                  <div className="flex items-center mb-2">
                    <svg className="w-4 h-4 mr-2 text-primary" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M13 6a3 3 0 11-6 0 3 3 0 016 0zM18 8a2 2 0 11-4 0 2 2 0 014 0zM14 15a4 4 0 00-8 0v3h8v-3zM6 8a2 2 0 11-4 0 2 2 0 014 0zM16 18v-3a5.972 5.972 0 00-.75-2.906A3.005 3.005 0 0119 15v3h-3zM4.75 12.094A5.973 5.973 0 004 15v3H1v-3a3 3 0 013.75-2.906z"></path></svg>
                    <h3 className="font-semibold text-primary dark:text-primary text-sm mb-0">Fellowships</h3>
                  </div>
                  <ul className="text-neutral-700 dark:text-neutral-300 text-xs space-y-1 pl-4 mt-1">
